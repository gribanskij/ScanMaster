...
public class GraphicOverlay extends View {
  ...
  protected void onDraw(Canvas canvas) {
    super.onDraw(canvas);
      ...
      float centTop = (float)(getHeight()/2);
      float centLeft = (float)(getWidth()/2);

      rect.left = centLeft - getWidth()/6;
      rect.top = centTop + getWidth()/6;
      rect.bottom = centTop - getWidth()/6;
      rect.right = centLeft + getWidth()/6;
