...
class BarcodeGraphic constructor(overlay: GraphicOverlay?, private val barcode: Pair<Barcode,String>) :
  ...
  override fun draw(canvas: Canvas) {
    ...
    val rect = RectF(barcode.first.boundingBox)
    ...
    val textWidth = barcodePaint.measureText(barcode.second)
    canvas.drawRect(
    ...
    canvas.drawText(barcode.second, rect.left, rect.top - STROKE_WIDTH, barcodePaint)
  }
